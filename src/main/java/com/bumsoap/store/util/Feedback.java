...
public class Feedback {
    ...
    public static final String PASSWORD_CHANGED = "비밀번호가 재 설정되었습니다.";
    public static final String PWD_RESET_EMAIL_SENT = "비밀번호 재설정 메일 전송";
    ...
    public static final String NOT_FOUND_EMAIL = "자격정보 오류";
    public static final String LOGIN_SUCCESS = "로그인 인증 성공";
    public static final String BAD_CREDENTIAL = NOT_FOUND_EMAIL;
    public static final String PASSWORDS_MISMATCH = "두 비밀번호 불일치";
    ...
    public static final String PRICE_INSERT_SUCC = "비누 가격 갱신 성공";
    ...
    public static final String FEE_OTHER_INSERTED = "섬 할증료 등 갱신 성공";
    ...
    public static final String REVIEW_DELETED = "주문 후기 삭제됨";
    public static final String REVIEW_DELETE_FAILED = "후기 삭제 실패함";
    ...
    public static final String DELETED_QUESTION_ID = "삭제된 질문 ID: ";
    public static final String ANSWERED_QUESTION = "댓글 달린 질문 삭제 불가";
