...
public class UrlMap {
    ...
    public static final String CHANGE_DEPT = "/{id}/change_dept";
    ...
    public static final String GET_CUSTOMER_PAGE = "/get_customer_page";
    public static final String GET_WORKER_PAGE = "/get_worker_page";
    ...
    public static final String ADD_FEE_OTHER = "/add_fee_other";
    ...
    public static final String GET_SOAP_PRODUCE_CHART = "/soap_produce_chart";
    /*== ADMIN / 관리자 끝 ==================================*/
    ...
    public static final String DELETE_REVIEW = "/{id}/delete_review";
    ...
    public static final String UPDATE_WAYBILL_NO = "/update_waybill_no";
